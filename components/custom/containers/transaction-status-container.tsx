...
import QueryDocumentationContainer from '../documentation/query_documentation'
...
const TransactionStatusContainer = () => {
  ...
  const url = `${api_endpoints.merchant.makeTransactionQueryRequest}/${tRef}`;
      ...
      <div className="max-w-4xl w-full">
        <Card className="max-w-2xl mx-auto">
          <CardHeader>
            ...
            <p className="text-sm text-gray-500">Transaction Query</p>
          </CardHeader>
