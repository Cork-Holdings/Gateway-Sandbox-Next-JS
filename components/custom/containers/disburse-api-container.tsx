...
const DisbursementAPIContainer = () => {
    ...
    const makeRequest = async () => {
        try {
            ...
            const apiResponse = await fetch(api_endpoints.merchant.makeDisburseRequest, {
                method: "POST",
                headers: {
    ...
    return (
        <main className='flex flex-col lg:flex-row gap-8  bg-gray-100 p-6'>
                ...
                <Card className="max-w-2xl mx-auto">
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div>
                                <Label htmlFor="narration" className="text-sm font-medium flex items-center gap-1">
                                    Narration
                                    <Badge variant="outline" className="ml-1 font-normal">Required</Badge>
                ...
                <Card className="max-w-2xl mx-auto mt-6">
                    ...
                    <CardContent>
                        <div className="space-y-2 text-sm">
                            <p><strong>Endpoint:</strong> {api_endpoints.merchant.makeDisburseRequest}</p>
                                ...
                                {JSON.stringify(
                                    {
                                        ...
                                        "X-Callback-URL": callBackUrl || '[X-Callback-URL]',
                                    },
                                    null,
                                    2
                                )}
            ...
            <DisbursementAPIDocumentationContainer />
        </main>
    )
}

export default DisbursementAPIContainer