      ...
      <div className="flex flex-col md:flex-row gap-12 items-center">
        <div className="flex-1 space-y-6">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
            Payment Gateway
            <span className="block text-yellow-300">API Sandbox</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            ...
            size="lg" className="bg-yellow-400 hover:bg-yellow-500 text-black">
              Get Started <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
            <Button size="lg" variant="outline" className="border-white text-indigo-800 hover:bg-indigo-800 hover:text-white">
              Documentation <Code className="ml-2 h-4 w-4" />
            </Button>
          </div>
        </div>
        <div className="flex-1 relative h-64 md:h-96 w-full">
          <div className="absolute -top-6 -left-6 w-full h-full bg-yellow-400 rounded-lg"></div>
