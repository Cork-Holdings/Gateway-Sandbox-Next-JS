        ...
        <div className="max-w-4xl w-full mx-auto p-6 bg-white dark:bg-inherit border rounded-lg shadow-md">
            ...
            <div className="border-b pb-6 mb-6">
                <div className="flex items-center gap-2 mb-2">
                    ...
                    <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Name Lookup</h1>
                </div>
                <p className="text-gray-600 dark:text-gray-300">This enables you query user names using a simple API call</p>
            </div>
            ...
            <div className="mb-8">
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded-md p-4 mb-6 overflow-auto whitespace-pre-wrap break-words">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <code className="text-sm font-mono bg-gray-200 dark:bg-gray-800 px-2 py-1 rounded">{`${api_endpoints.merchant.makeNameLookupRequest}/{phone_number}`}</code>
                    </div>
                </div>
            </div>
