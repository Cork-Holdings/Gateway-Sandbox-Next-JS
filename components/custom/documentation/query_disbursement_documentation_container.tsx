        ...
        <div className="max-w-4xl w-full mx-auto p-6 bg-white rounded-lg shadow-md">
            ...
            <div className="border-b pb-6 mb-6">
                <div className="flex items-center gap-2 mb-2">
                    ...
                    <h1 className="text-2xl font-bold text-gray-800">Query Disbursement Status</h1>
                </div>
                <p className="text-gray-600">This enables you to check the status on a given  transaction</p>
            </div>
