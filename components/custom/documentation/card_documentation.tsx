        ...
        <div className="max-w-4xl w-full mx-auto p-6 bg-white dark:bg-inherit rounded-lg shadow-md dark:shadow-2xl rounded-3xl">
            ...
            <div className="border-b pb-6 mb-6">
                <div className="flex items-center gap-2 mb-2">
                    ...
                    <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Create Checkout URL</h1>
                </div>
                <p className="text-gray-600 dark:text-white">This enables you to create a hosted checkout endpoint</p>
            </div>
            ...
            <div className="mb-8 dark:bg-gray-800 dark:text-white">
                ...
                <div className="bg-gray-50 dark:bg-gray-900 rounded-md p-4 mb-6 overflow-auto whitespace-pre-wrap break-words">
                    <div className="flex items-center gap-2 mb-2">
                        <span className="bg-indigo-600 text-white text-xs font-medium px-2 py-1 rounded">POST</span>
                        <code className="text-sm font-mono bg-gray-200 dark:bg-gray-900 px-2 py-1 rounded">{`${api_endpoints.merchant.makeAddCheckoutRequest}`}</code>
                    </div>
                </div>
            </div>

            {/* Headers Section */}
            <div className="mb-8 dark:bg-gray-800">
                <div className="flex items-center gap-2 mb-4">
                    <Code className="text-indigo-600" size={20} />
                    <h2 className="text-xl font-semibold text-gray-800">Request Headers</h2>
                </div>

                <div className="bg-gray-50 dark:bg-gray-900 rounded-md p-4 overflow-hidden">
