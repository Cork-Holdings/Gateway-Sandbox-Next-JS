...
const hostedSchema = z.object({
    ...
    amount: z.string().optional(), // ← previously `.email()`
  });
...
const HostedCheckoutForm: React.FC<hostedCheckoutFormProps> = (
    {
   details 
}) => {
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                          disabled={details?.order_id!= null ? true : false}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                        disabled={details?.amount!= null ? true : false}
                                            {...field}
                                            type="text"
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                           disabled={details?.customer_email!= null ? true : false}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                           disabled={details?.customer_name!= null ? true : false}
